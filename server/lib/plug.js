var BOOT_STATUS, DOCS, IS_INIT, USERS, authFP, bootStatus, buildACL, buildSelect, buildSelectDoc, close, deleteDoc, deleteMatch, deleteShare, deleteUser, init, insertDoc, insertDocs, insertShare, insertUser, insertUsers, isInit, java, jdbcJar, match, matchAll, plug, selectDocs, selectDocsByDocID, selectUsers, selectUsersByUserID;
...
insertDocs = function(docids, shareid, userParams, callback) {
  ...
  return plug.plugInsertDocs(array, shareid, userParams, function(err) {
...
insertUsers = function(userids, shareid, userParams, callback) {
  ...
  return plug.plugInsertUsers(array, shareid, userParams, function(err) {
    return callback(err);
  });
};
