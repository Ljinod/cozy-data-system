...
selectInPlug = function(id, callback) {
  return async.series([
    ...
    if (res != null) {
      console.log('tuples select : ' + JSON.stringify(res));
    }
    return callback(err, res);
  });
};
