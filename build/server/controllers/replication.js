...
couchDBHeaders = function(nodeHeaders) {
  var couchHeaders, name, _i, _len, _ref;
  couchHeaders = {};
  _ref = Object.keys(nodeHeaders);
...
module.exports.proxy = function(req, res, next) {
  var couchReq, data, err, options, permissions, stream, _ref;
  console.log('hop');
  _ref = requestOptions(req), err = _ref[0], options = _ref[1];
      ...
      if (req.method === 'GET') {
        if (permissions) {
          ...
          if (headers['Content-Type'] === 'application/json') {
            ...
            _ref1 = retrieveJsonDocument(content), err = _ref1[0], doc = _ref1[1];
          }
          if (doc) {
  ...
  req.on('data', (function(_this) {
    return function(chunk) {
      ...
      if (permissions) {
        ...
        data.push(chunk);
        _ref1 = retrieveJsonDocument(Buffer.concat(data).toString()), err = _ref1[0], doc = _ref1[1];
