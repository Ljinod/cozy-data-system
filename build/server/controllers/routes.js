...
var access, account, attachments, binaries, connectors, data, indexer, mails, plugdb, replication, requests, sharing, user, utils;
...
module.exports = {
  ...
  'replication/*': {
    'post': [replication.proxy],
    'get': [replication.proxy],
    'put': [replication.proxy]
  },
