...
updateProcess = function(id, mapResults, selectResults, callback) {
  ...
  existDocOrUser = function(shareID) {
    var doc, user;
    if ((selectResults[0] != null) && (selectResults[0].shareID != null)) {
      if (selectResults[0].shareID === shareID) {
        doc = selectResults[0];
      }
      console.log('doc : ' + JSON.stringify(doc));
    }
    if ((selectResults[1] != null) && (selectResults[1].shareID != null)) {
      if (selectResults[1].shareID === shareID) {
        user = selectResults[1];
      }
    }
    return {
      doc: doc,
