...
module.exports.evalDelete = function(id, callback) {
  var rule;
  rule = getRuleById(id);
...
createRule = function(doc, id, callback) {
  return plug.insertShare(id, doc.name, function(err) {
    var rule;
    if (err != null) {
      return callback(err);
    } else {
